...
<div id="message-body-wrapper">
	<ul class="link-list-wrapper">
		<li class="active"><a href="<?php echo url("message::default/index");?>">收件箱</a></li>
	...
	<table id="message-table">
		...
		<tr">
			...
			<td><?php echo $message['senderName']; ?></td>
			<td>
				<?php if ( in_array(strtoupper(Helper_User::getUserGroup($message['sender'])), array("ADMIN", "ADVANCEDEDITOR")) ) : ?>
	...
	<?php $this->_control('pagination', 'entrust-case-pagination', array('pagination'=>$pagination, 'base'=>$base) ); ?>
</div>
